...
import app.gaojinlei.note.model.INoteFolderModel;
import app.gaojinlei.note.model.LoadDataCallBack;
import app.gaojinlei.note.model.NoteFolderModel;
import app.gaojinlei.note.module.base.BasePresenter;
import app.gaojinlei.note.module.notes.main.INoteMainPresenter;
    ...
    public void getFolders() {
        mINoteFolderModel.loadNoteFoldersList(new LoadDataCallBack<NoteFolder>() {
            ...
            protected void onSuccedd(List<NoteFolder> list) {
                ...
                setAllNoteCount(list);//设置所有便签的数目
            }
        });
    }
