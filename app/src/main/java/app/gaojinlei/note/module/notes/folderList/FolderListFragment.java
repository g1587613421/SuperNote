...
import app.gaojinlei.note.adapter.RvNoteFolderAdapter;
...
import app.gaojinlei.note.module.base.BaseFragment;
import app.gaojinlei.note.module.notes.folder.FolderActivity;
import app.gaojinlei.note.module.notes.main.NoteMainActivity;
import app.gaojinlei.note.module.setting.developer.DeveloperActivity;
import app.gaojinlei.note.module.setting.feedback.FeedbackActivity;
import app.gaojinlei.note.module.setting.main.SettingMainActivity;
import app.gaojinlei.note.utils.ThemeUtils;
import app.gaojinlei.note.weather.weatherActivity;
...
public class FolderListFragment extends BaseFragment<IFolderListView, FolderListPresenter>
    ...
    private View getFolderHeaderView() {
        ...
        TextView tvToweather=(TextView)mHearderView1.findViewById(R.id.show_weather);
        tvToFeedback.setOnClickListener(this);
        tvToDev.setOnClickListener(this);
        tvToweather.setOnClickListener(this);
